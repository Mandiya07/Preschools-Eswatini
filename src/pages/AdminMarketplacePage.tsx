...
const STOREFRONTS = [
  {
    id: "uniforms",
    name: "Uniform Marketplace",
    description: "Launch your own online uniform store with full inventory management and direct sales to parents.",
    price: "5% Rev Share",
  ...
  {
    id: "supplies",
    name: "Preschool Supplies Marketplace",
    description: "Sell approved back-to-school kits and everyday classroom supplies directly to parents.",
    price: "5% Rev Share",
  ...
  {
    id: "toys",
    name: "Educational Toys Marketplace",
    description: "Curate and sell STEM toys, puzzles, and sensory items for inspired learning.",
    price: "10% Rev Share",
  ...
  {
    id: "downloads",
    name: "Learning Materials Downloads",
    description: "Sell premium digital worksheets, coloring books, and at-home learning lesson guides.",
    price: "Free to Setup",
