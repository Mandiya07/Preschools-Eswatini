...
export function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 space-y-8">
      <SEO title="Privacy Policy | Preschools Eswatini Platform" />
      <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Privacy Policy</h1>
      
      <div className="prose prose-slate max-w-none text-slate-600">
        <p>At Preschools Eswatini, we take your privacy seriously. This privacy policy explains how we collect, use, and protect your information when you use our platform.</p>
        ...
        <p>We use your information to operate, maintain, and provide the features of the Preschools Eswatini platform, and to communicate with you regarding your school's account and updates.</p>
